...
<body>
	...
	<div style="text-align: center">
		<form name="login" method="get" action="loginAction_miyoung.jsp" id="login">
	...
	<!-- 	<form action="loginAction_miyoung.jsp">
		아이디 <input type="text" name="memb_id" id="memb_id" /> 비번 <input
			type="text" name="memb_pw" id="memb_pw" />
		<button onClick="login_ck()">로그인</button>
	</form> -->
